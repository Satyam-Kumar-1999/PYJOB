...
def delete_application(request, application_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('all_applicants')  # Assuming 'all_applicants' is the name of the URL pattern for the all applicants page
    # If request method is not POST, just redirect back to the same page
    return redirect('all_applicants')  # You can adjust this to redirect to any other page as needed